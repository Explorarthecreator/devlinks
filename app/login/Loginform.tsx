    ...
    <form className=" flex flex-col gap-3" onSubmit={submit}>
        <div className="flex gap-2 flex-col">
            ...
            <div className="w-full input input-bordered flex items-center gap-2">
                ...
                <input type="email" className="grow w-1/2" placeholder="Email" id="email" value={email} onChange={change}/>
        ...
        <div className="flex gap-2 flex-col">
            ...
            <div className="w-full input input-bordered flex items-center gap-2">
                ...
                {/* Do not forget to change the width of the input to allow you          */}
                <input type="password" className="grow w-1/2" placeholder="Password" id="password" value={password} onChange={change} />
                <span className="text-xs hidden">
                    check again
                </span>
            </div>
        ...
        <button className="btn w-full mt-4  bg-[#633CFF] text-white" onClick={(e)=>submit(e)}>
            Login
        </button>
